...
$(document).ready(function () {
    ...
    $("#supplier_id").on('change', function () {
        supplier_has_vat= $('#supplier_id option:selected').data('vat');
        ...
        if(purses.length != 0){
            $("#pursesDetailsRender").append(
                ...
                $("<tr>").append(
                    ...
                    $("<th>",{html:'<form id="imgform" name="imgform" enctype="multipart/form-data"><input class="form-control" type="file" name="img" id="img"></form> ',
                        // $("<input/>",{type:"file",
                        //     value:"0", min:"0", style:"width: 120px",class:"form-control",
                        //     id:"image",
                    })
                ...
                $("<tr>").append(
                    $("<th>",{colspan:6}),
                    $("<th>").append(
                        $("<button>",{text:"Confirm Purses",class:"btn btn-brand btn-elevate btn-icon-sm",onClick:'$(this).confirmPurses()'})
                    )
                )
            )
        }
