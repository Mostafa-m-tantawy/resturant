            ...
            <ul class="kt-menu__nav ">
                ...
                <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                    ...
                    <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                        ...
                        <span class="kt-menu__link-text">{{trans('main.employees')}}</span><i
                            class="kt-menu__ver-arrow la la-angle-right"></i></a>
                    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                        <ul class="kt-menu__subnav">
                            <li class="kt-menu__item " aria-haspopup="true"><a href="{{route('employee.index')}}"
                                                                               class="kt-menu__link ">
                                    <span
                                        class="kt-menu__link-text">{{trans('main.all')}} {{trans('main.employees')}}</span></a>
                            </li>
                            <li class="kt-menu__item " aria-haspopup="true">
                                <a href="{{route('employee.create')}}" class="kt-menu__link ">
                                    <span  class="kt-menu__link-text">
                                        {{trans('main.create')}} {{trans('main.employee')}}</span></a>
                            </li>
                ...
                <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                    ...
                    <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                        ...
                        <span class="kt-menu__link-text">{{trans('main.leaves')}}</span><i
                            class="kt-menu__ver-arrow la la-angle-right"></i></a>
                    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                        <ul class="kt-menu__subnav">
                            <li class="kt-menu__item " aria-haspopup="true"><a href="{{route('leave-type.index')}}"
                                                                               class="kt-menu__link ">
                                    <span
                                        class="kt-menu__link-text"> {{trans('main.leaves types')}}</span></a>
                            </li>
                            <li class="kt-menu__item " aria-haspopup="true">
                                <a href="{{route('leave.create')}}" class="kt-menu__link ">
                                    <span  class="kt-menu__link-text">
                                        {{trans('main.create')}} {{trans('main.leave')}}</span></a>
                            </li>
                            <li class="kt-menu__item " aria-haspopup="true">
                                <a href="{{route('leave.index')}}" class="kt-menu__link ">
                                    <span  class="kt-menu__link-text">
                                        {{trans('main.all')}} {{trans('main.leaves')}}</span></a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                    ...
                    <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                        ...
                        <span class="kt-menu__link-text">{{trans('main.approves')}}</span><i
                            class="kt-menu__ver-arrow la la-angle-right"></i></a>
                    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                        <ul class="kt-menu__subnav">
                            <li class="kt-menu__item " aria-haspopup="true">
                                <a href="{{route('approve-type.index')}}" class="kt-menu__link ">
                                    <span
                                        class="kt-menu__link-text"> {{trans('main.approves types')}}</span></a>
                            </li>
                            ...
                            <li class="kt-menu__item " aria-haspopup="true">
                                <a href="{{url('hr/approve-request/my-requests')}}" class="kt-menu__link ">
                                    <span  class="kt-menu__link-text">
                                        {{trans('main.my requests')}} </span></a>
                            </li>
                            <li class="kt-menu__item " aria-haspopup="true">
                                <a href="{{url('hr/approve-request/my-approves')}}" class="kt-menu__link ">
                                    <span  class="kt-menu__link-text">
                                        {{trans('main.my approves')}} </span></a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="kt-menu__item " aria-haspopup="true">
                    <a href="{{route('asset.index')}}" class="kt-menu__link ">
                     <span class="kt-menu__link-icon">
                         <img class="img-fluid" src="{{url('media/icons/dasbaoard.png')}}" height="34"width="34">
                     </span>
