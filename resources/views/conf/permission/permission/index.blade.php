                ...
                <table id="datatable-responsive"
                    ...
                    @foreach($permissions as $permission)
                        <tr>
                            ...
                            <td><a class="btn btn-primary" href="{{route('permission.show',[$permission->id])}}">show </a></td>
                            <td>
                                <a title="update"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{route('permission.store')}}" method="post">
                    <div class="modal-header">
                        <h5 class="modal-title"> {{trans('main.new permission')}} <span
    ...
    <script>
        $(document).ready(function () {
            $('#updateAsset').on('show.bs.modal', function (e) {
                ...
                $(e.currentTarget).find('form').attr('action', "{{url('conf/permission/')}}/" + Id);
            });
