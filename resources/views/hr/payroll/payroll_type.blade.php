...
@section('content')
            ...
            <div class="modal-content">
                <form method="post">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">{{trans('main.update')}} {{trans('main.payroll-type')}}</h5>
    ...
    <div class="modal fade newLeaveType" id="newLeaveType" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{route('payroll-type.store')}}" method="post">
                    <div class="modal-header">
                        <h5 class="modal-title"> {{trans('main.new payroll type')}} <span
...
//
            $('#updateAsset').on('show.bs.modal', function (e) {
                ...
                $(e.currentTarget).find('form').attr('action', "{{url('hr/payroll-type/')}}/" + Id);
            });
